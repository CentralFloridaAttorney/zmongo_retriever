...
class TestOpenAIModelReal(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_record_id_str_converts_to_objectid(self):
        ...
        async def mock_update_document(collection, query, update_data, upsert=False):
        ...
        class MockZMongo:
            ...
            async def update_document(self, collection, query, update_data, upsert=False):
                return await mock_update_document(collection, query, update_data, upsert)
