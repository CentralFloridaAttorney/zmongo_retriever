...
class TestLlamaModelDownload(unittest.TestCase):
    @patch("zmongo_retriever.zmongo_toolbag.llama_model.urllib.request.urlretrieve")
    @patch("zmongo_retriever.zmongo_toolbag.llama_model.os.makedirs")
    @patch("zmongo_retriever.zmongo_toolbag.llama_model.os.path.isfile", return_value=False)
    ...
    @patch("zmongo_retriever.zmongo_toolbag.llama_model.os.path.isfile", return_value=True)
