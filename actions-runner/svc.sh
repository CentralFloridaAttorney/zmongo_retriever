...
SVC_NAME="actions.runner.CentralFloridaAttorney-zmongo_retriever.overlordx-OMEN-by-HP-Desktop-PC-880-p1xx.service"
SVC_NAME=${SVC_NAME// /_}
SVC_DESCRIPTION="GitHub Actions Runner (CentralFloridaAttorney-zmongo_retriever.overlordx-OMEN-by-HP-Desktop-PC-880-p1xx)"
