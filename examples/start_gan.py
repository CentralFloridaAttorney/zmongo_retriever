...
import os
import argparse
from zai_toolbag.gan import CupyGAN, CombinedCupyGAN, create_sample_image, get_next_model_filename

def main():
    parser = argparse.ArgumentParser(description="Train a simple CuPy GAN on an image.")
