...
class ZMongoRetriever:
    ...
    def _create_default_metadata(self, mongo_object):
        ...
        essential identifiers. Additionally, it specifies the `page_content_key` to indicate
        ...
        return {
            ...
            "page_content_key": self.page_content_field
        }
...
if __name__ == "__main__":
    ...
    zdocument = retriever.get_zdocuments(object_ids=zcase_db_object_ids,
                                         page_content_key='casebody.data.opinions.0.text')
